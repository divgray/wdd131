// Set current year and last modified info
...
function Displaymovies(movies) {
    ...
    movies.forEach(m => {
        ...
        // Retrieve the See More button and corresponding summary paragraph
        const seeMoreButton = card.querySelector(".see-more");
        const summaryParagraph = card.querySelector(".summary");

        // Toggle the "open" class and update button text
...
// Navigation elements (they are <a> elements, not buttons)
...
// Update active state for nav items (targeting anchor tags now)
...
// const seeMoreButton = movie-card.querySelector(".see-more");
// const summaryParagraph = movie-card.querySelector(".summary");
